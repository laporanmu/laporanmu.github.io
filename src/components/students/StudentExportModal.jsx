                    ...
                    <div className="space-y-3">
                        <div className="flex items-center justify-between">
                            ...
                            <div className="flex gap-2">
                                ...
                                <button onClick={() => handlePresetClick(['nama', 'kelas'])} className="text-[9px] font-black text-[var(--color-text-muted)] hover:underline uppercase tracking-widest bg-[var(--color-surface-alt)] px-2 py-1 rounded-lg transition-colors">Reset</button>
                            </div>
                        </div>
                    ...
                    <div className="space-y-3">
                        ...
                        <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5">
                            {[
                                ...
                                {
                                    label: 'PDF Kartu', icon: faIdCard, desc: 'Foto',
                                    onClick: async () => {
                                        let targets = []
