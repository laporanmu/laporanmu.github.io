...
export const RAPORT_AR_FONT = "'Noto Naskh Arabic', 'Traditional Arabic', 'Arial Unicode MS', serif"
...
export const RAPORT_FONT_LINKS = [
  'https://fonts.googleapis.com/css2?family=Inter:wght@400;600;700&family=Noto+Naskh+Arabic:wght@400;600;700&display=block',
...
export const preloadRaportFonts = async () => {
  ...
  try {
    await Promise.all([
      ...
      document.fonts.load('600 16px "Noto Naskh Arabic"'),
