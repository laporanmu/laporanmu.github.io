                ...
                <div className="flex flex-col sm:flex-row gap-3 p-3">
                    ...
                    <div className="flex items-center gap-2">
                        <button onClick={() => setShowAdvFilter(!showAdvFilter)}
                            className={`flex-1 sm:flex-none h-9 px-4 rounded-xl border text-[10px] font-black uppercase tracking-widest transition-all flex items-center justify-center gap-2 ${showAdvFilter || activeFilterCount > 0 ? 'bg-[var(--color-primary)] border-[var(--color-primary)] text-white shadow-md shadow-[var(--color-primary)]/30' : 'border-[var(--color-border)] text-[var(--color-text-muted)] hover:bg-[var(--color-surface-alt)]'}`}>
