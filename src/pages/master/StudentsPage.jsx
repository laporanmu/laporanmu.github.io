    ...
    return (
        <DashboardLayout title="Data Siswa" hideHeader={isAnyModalOpen} hideSidebar={isAnyModalOpen}>
            ...
            <div className="p-4 md:p-6 space-y-4 max-w-[1800px] mx-auto">
                ...
                {/* Stats Row Wrapper with Scroll Indicator */}
                <div className="relative mb-6 -mx-3 sm:mx-0 group/scroll">
                    <div className="flex overflow-x-auto scrollbar-hide gap-3 pb-2 snap-x snap-mandatory px-3 sm:px-0 sm:grid sm:grid-cols-2 lg:grid lg:grid-cols-5 lg:overflow-visible lg:pb-0 lg:snap-none">
                        <div className="min-w-[160px] md:min-w-0 flex-1 shrink-0 snap-center glass rounded-[1.5rem] p-4 border-t-[3px] border-t-[var(--color-primary)] flex items-center gap-3 group hover:border-t-4 transition-all hover:bg-[var(--color-primary)]/5">
                        ...
                        <div className="min-w-[160px] md:min-w-0 flex-1 shrink-0 snap-center glass rounded-[1.5rem] p-4 border-t-[3px] border-t-blue-500 flex items-center gap-3 group hover:border-t-4 transition-all hover:bg-blue-500/5">
                        ...
                        <div className="min-w-[160px] md:min-w-0 flex-1 shrink-0 snap-center glass rounded-[1.5rem] p-4 border-t-[3px] border-t-pink-500 flex items-center gap-3 group hover:border-t-4 transition-all hover:bg-pink-500/5">
                        ...
                        <div
                            className="min-w-[170px] md:min-w-0 flex-1 shrink-0 snap-center glass rounded-[1.5rem] p-4 border-t-[3px] border-t-emerald-500 flex items-center gap-3 group hover:border-t-4 transition-all hover:bg-emerald-500/5 cursor-pointer"
                        ...
                        {/* Kelas Bermasalah */}
                        <div
                            className="min-w-[180px] md:min-w-0 flex-1 shrink-0 snap-center glass rounded-[1.5rem] p-4 border-t-[3px] border-t-red-500 flex items-center gap-3 group hover:border-t-4 transition-all hover:bg-red-500/5 cursor-pointer sm:col-span-2 lg:col-span-1"
                        ...
                        >
                            ...
                            <div className="min-w-0">
                                ...
                                {globalStats.worstClass ? (
                                    <>
                                        <h3 className="text-[13px] font-black font-heading leading-tight text-red-500 truncate" title={globalStats.worstClass.name}>{globalStats.worstClass.name}</h3>
                    ...
                    {/* Mobile Scroll Indicator (Right Edge Fade Arrow) */}
                    <div className="absolute right-0 top-0 bottom-2 w-12 bg-gradient-to-l from-[var(--color-surface)] via-[var(--color-surface)]/80 to-transparent flex items-center justify-end pr-1 pointer-events-none sm:hidden opacity-80 z-10">
                        <div className="w-6 h-6 rounded-full bg-[var(--color-primary)]/10 text-[var(--color-primary)] flex items-center justify-center animate-pulse backdrop-blur-sm shadow-sm">
